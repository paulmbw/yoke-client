    ...
    <Section>
      <AboutContainer>
        ...
        <StyledText>
          ...
          to be running too, and ask "hey, mind if I join?" Easy, right? No. Not quite.
        </StyledText>
        <StyledText>
          Especially for someone as introverted as me. Simply asking someone to join in thier run is something
        ...
        <StyledText>
          ...
          but I see it as something else. I see Yoke as an opportunity for two or more like minded people to share
          what they have in common: sport. Be it a 5k run, a yoga session, a round of table tennis, Yoke is about
          finding that peerson to share your sport with, and ultimately build a new connection because life is all about people.
        </StyledText>
        <h2>How?</h2>
        <StyledText>
